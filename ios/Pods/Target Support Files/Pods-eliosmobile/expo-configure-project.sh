...
with_node \
  ...
  --target "/Users/louisperrenot/projet_docker/elios/elios_mobile/ios/Pods/Target Support Files/Pods-eliosmobile/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-router" "expo-secure-store" "expo-system-ui" "expo-web-browser"
