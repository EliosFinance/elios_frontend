...
export const challenges: ChallengeType[] = [
  {
    ...
    backgroundImage:
      'https://images.unsplash.com/photo-1573164574601-8b3d01bab9b3?auto=format&q=80&w=400',
    rewards: [
      {
        id: 1,
  ...
  },
  {
    ...
    backgroundImage:
      'https://images.unsplash.com/photo-1610092374657-6aab0b236edb?auto=format&q=80&w=400',
    rewards: [
      {
        id: 2,
    ...
    description:
      'Pendant 7 jours, suivez un plan d’action pour réduire vos sorties d’argent.',
    progress: 100,
    total: 700,
    leaderboard: [
      {
  ...
  },
  {
    ...
    backgroundImage:
      'https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&q=80&w=400',
    rewards: [
      {
        id: 3,
        title: 'Gagnez +100 XP',
    ...
    description:
      'Réduisez vos dépenses inutiles en identifiant celles-ci et en adoptant de nouvelles habitudes.',
    progress: 0,
    total: 1000,
    leaderboard: [],
    category: challengeCategoryEnum.BUDGET,
