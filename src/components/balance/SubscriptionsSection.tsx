                ...
                <>
                    <div className='space-y-3 mb-4'>
                        {subscriptions.map((sub) => (
                            <div key={sub.id} className='flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10'>
                                <div className='flex items-center gap-3'>
                                    <div className='flex items-center justify-center w-8 h-8 rounded-lg bg-white/5 border border-white/10'>
                                        <svg className='w-4 h-4' viewBox='0 0 24 24' fill='none'>
                                            <circle cx='12' cy='12' r='10' stroke='currentColor' strokeWidth='2' className='text-primary-400'/>
                                            <path d='M12 6v6l4 2' stroke='currentColor' strokeWidth='2' className='text-primary-400'/>
                                        </svg>
                                    </div>
