		...
		<div className="flex flex-col items-center w-full bg-[#181823]">
			<section className="w-full px-6 mt-6">
				...
				<div className="space-y-4">
					<Card
						className={`cursor-pointer ${selectedPlan === 'annual' ? 'border-2 border-primary-500 bg-[#171723]' : 'bg-[#181823]'}`}
						...
						<CardContent className="flex items-center justify-between">
							<div className="flex items-center space-x-2">
								...
								<div>
									...
									<p className="text-sm text-gray-200">Economisez 20%</p>
								</div>
							</div>
							<div className="text-right">
								<span className="text-lg font-bold">47,99€</span>
								<p className="text-sm text-gray-200">/an</p>
							</div>
						</CardContent>
					</Card>

					<Card
						className={`cursor-pointer ${selectedPlan === 'monthly' ? 'border-2 border-primary-500 bg-[#171723]' : 'bg-[#181823]'}`}
					...
					>
						<CardContent className="flex items-center justify-between">
							...
							<div className="text-right">
								...
								<p className="text-sm text-gray-200">/mois</p>
							</div>
						</CardContent>
					</Card>
				</div>

				<Button className="w-full py-3 mt-6 rounded-full bg-primary-500">
					Je deviens Premium
				</Button>
			</section>
		</div>
