            ...
            <section className="w-full mt-6">
                ...
                <div className="bg-gray-100 p-4 rounded mb-4 flex items-center justify-between">
                    <input
                        ...
                        readOnly
                    />
                    <button onClick={copyToClipboard} className="bg-gray-300 text-sm px-2 py-1 rounded">Copy</button>
                </div>
                ...
                <div className="bg-gray-100 p-4 rounded mb-4">
                    <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center">
                            <img src="https://images.unsplash.com/photo-1574607407517-cd664b1504f5?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8Y29pbnN8ZW58MHx8MHx8fDA%3D" alt="EliCoins" className="w-16 h-16 mr-2" />
                ...
                <div className="flex justify-between mb-4">
                    ...
                    <Drawer>
                        <DrawerTrigger asChild>
                            <button className="bg-blue-500 text-white py-2 px-4 rounded flex-1">Comment ça marche</button>
                        </DrawerTrigger>
                        <DrawerContent>
                            <DrawerHeader>
                ...
                <div className="flex justify-between items-center mb-2">
                    <h3 className="text-lg font-bold">Récompenses <InformationCircleIcon className="w-4 h-4 inline" /></h3>
                ...
                {[...Array(4)].map((_, index) => (
                    <div key={index} className="bg-gray-100 p-4 rounded mb-4 flex items-center justify-between">
                        <img src="https://images.unsplash.com/photo-1534308983496-4fabb1a015ee?q=80&w=3276&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Reward" className="w-10 h-10 mr-4" />
