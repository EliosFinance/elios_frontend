...
const LearnQuizzTab = (props: LearnQuizzTabProps) => {
	...
	const SliderSection = () => {
		return (
			<div className='flex flex-col items-start justify-center w-full pt-6 mb-2'>
				<div className='flex items-center justify-between w-full'>
					<h2 className='text-2xl font-black'>Quizz</h2>
				</div>
				<div className='w-full mt-2 mb-3 overflow-x-auto scrollbar-hide'>
		...
		<div className='flex flex-col items-start justify-center w-full py-4 mb-8 gap-y-6'>
			...
			>
				<div className='flex items-center justify-center h-auto gap-2'>
					...
					<p className='text-xl font-bold text-purple-500'>{stats.rank}</p>
					<Badge variant='default' className='text-black bg-primary-500'>
			...
			<SliderSection />
			<div className='flex flex-wrap items-start justify-start w-full pb-24 gap-y-4 gap-x-4'>
					...
					<div className='flex-1 w-full h-full pb-6 overflow-y-auto'>
						{activeTab === 'quizz' && (
							<div className='flex flex-col items-center justify-center p-4 gap-y-4'>
								<h4 className='flex items-center gap-2 text-xl font-bold text-purple-500'>
									<Trophy className='w-5 h-5' />
									1. Maître de la finance
								</h4>
								<h4 className='flex items-center gap-2 text-xl font-bold text-red-500'>
									<Award className='w-5 h-5' />
									2. Banquier
								</h4>
								<h4 className='flex items-center gap-2 text-xl font-bold text-green-500'>
									<Star className='w-5 h-5' />
									3. Amateur de graphiques
								</h4>
								<h4 className='flex items-center gap-2 text-xl font-bold text-amber-900'>
									<Target className='w-5 h-5' />
									4. Novice des écus
								</h4>

								<div className='w-full max-w-md mt-6'>
									<h5 className='mb-3 font-semibold'>Progression vers le prochain rang</h5>
						...
						{activeTab === 'achievements' && (
							<div className='p-4 space-y-4'>
								<h4 className='mb-4 text-lg font-semibold'>Vos Succès</h4>
						...
						{activeTab === 'stats' && (
							<div className='p-4 space-y-6'>
								<h4 className='mb-4 text-lg font-semibold'>Statistiques Détaillées</h4>
								...
								<div className='p-4 bg-gray-800 rounded-lg'>
									<h5 className='mb-3 font-semibold'>Domaines de prédilection</h5>
										...
										{[
											...
											<div key={index} className='flex items-center justify-between'>
												...
												<div className='flex items-center gap-2'>
													...
													<span className='w-10 text-sm font-semibold'>{item.score}%</span>
												</div>
											</div>
										))}
									</div>
