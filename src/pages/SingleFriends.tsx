        ...
        <div className="flex flex-col items-center">
            ...
            <section className="w-full mt-6 px-6">
                <div className="bg-white shadow rounded p-4 mb-4 flex items-center">
                    <img src={friend.profileImage} alt={friend.name} className="w-16 h-16 rounded-full mr-4" />
                    <div>
                ...
                <div className="bg-white shadow rounded p-4 mb-4">
                    ...
                    <div className="flex justify-between items-center mb-4">
                        <p>Category Chart</p>
                        <p className="font-bold">-${friend.weeklyExpenses.reduce((acc, exp) => acc + parseFloat(exp.amount.replace(/[^0-9.-]+/g, "")), 0).toFixed(2)}</p>
                    </div>
                    <div className="flex justify-between items-center mb-4">
